    ...
    public partial class usersignup : System.Web.UI.Page
    {
        ...
        void signUpNewMember()
        {
            ...
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("INSERT INTO member_master_tbl (member_id,full_name,dob,contact_no,email,state,city,pincode,full_address,password,account_status) values(@mem_id,@full_name,@dob,@contact_no,@email,@state,@city,@pincode,@full_address,@password,@account_status)", con);
                ...
                cmd.Parameters.AddWithValue("@mem_id", TextBox8.Text.Trim());
