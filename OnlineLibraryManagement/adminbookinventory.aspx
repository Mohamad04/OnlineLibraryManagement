...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">   <!--  since it is head evru thing created will be in the master pahe and in the head -->
    <script type="text/javascript">
        ...
        function readURL(input) {               // just for visualizing
            ...
            <div class="col-md-5">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col text-center">
                                <img id="imgview" width="100" height="150" src="book_inventory/books.png" />
                            </div>
                        </div>
                        <div class="row">
                            <div class="col">
                        ...
                        <div class="row">
                            <div class="col">
                                <asp:FileUpload onchange="readURL(this);" class="form-control" ID="FileUpload1" runat="server" />   <!-- by using javascript it is fired onclich event (front end) -->
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-3">
                                ...
                                <div class="form-group">
                                    <div class="input-group">
                                        ...
                                        <asp:LinkButton class="btn btn-primary" ID="LinkButton4" runat="server" OnClick="LinkButton4_Click" Text="Go"></asp:LinkButton>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-9">
            ...
            <div class="col-md-7">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="Data Source=SERHANACER\SQLEXPRESS;Initial Catalog=elibraryDB;Integrated Security=True" ProviderName="System.Data.SqlClient" SelectCommand="SELECT * FROM [book_master_tbl]"></asp:SqlDataSource>
                            <div class="col">
                                                        ...
                                                        <div class="col-lg-10">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-12">
                                                                    ...
                                                                    Publisher :
                                                                    <asp:Label ID="Label5" runat="server" Font-Bold="True" Text='<%# Eval("pubisher_name") %>'></asp:Label>
                                                                    &nbsp;| Publish_Date :
