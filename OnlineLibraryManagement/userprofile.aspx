                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col text-center">
                                ...
                                <!-- we sued span insted of div since it is an inline element and doesnot take the entire row -->
                                <asp:Label ID="Label1" class="badge badge-pill badge-success"
                                    runat="server" Text="Your status"></asp:Label>
                                <!-- it is asp label since it is dynamic label(it will at server bcz it will change the status depending on the database ) -->
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <!-- CssClass for asp component and class for html component can work too -->
                                </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <asp:TextBox CssClass="form-control" ID="TextBox6"
                                        runat="server" placeholder="dd-mm-yyyy" TextMode="Date"></asp:TextBox>
                                </div>
                        ...
                        <div class="row">
                            <div class="col text-center">
                                <span class="badge badge-pill badge-primary">Update Credentials</span>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    ...
                                    <!-- change property to read only = true-->
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    <asp:TextBox CssClass="form-control" ID="TextBox19"
                            ...
                            <div class="col-8 text-center mx-auto">
                                <div class="form-group">
                                    <a href="usersignup.aspx">
                                        <asp:Button ID="Button1" class="btn btn-primary btn-block btn-lg"
                                            runat="server" Text="Update" OnClick="Button1_Click" /></a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col text-center">
                                ...
                                <asp:Label ID="Label2" class="badge badge-pill badge-info" 
									runat="server" Text="Your BOOKS info"></asp:Label>          <!-- it is asp label since it is dynamic label(it will at server bcz it will change the status depending on the database ) -->
                            </div>
                        </div>
